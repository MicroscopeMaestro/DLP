...
def flash_118():
    ...
    print(f"--- STARTING DLP v1.1.8 FIRMWARE FLASH ---")
    ...
    try:
        ...
        print(f"Uploading {total_blocks} blocks of v1.1.8...")
        ...
        if status.Application.ToString() == "MainApp":
            print("\nSUCCESS! Controller is now in MainApp (v1.1.8).")
        else:
