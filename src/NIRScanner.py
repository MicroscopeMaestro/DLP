...
class NIRScanner(object):
    ...
    def setSlewConfigHeader(self, scanConfigIndex, num_repeats, num_sections):
        return _NIRScanner.NIRScanner_setSlewConfigHeader(self, scanConfigIndex, num_repeats, num_sections)

    def setSlewConfigSection(self, section_index, section_scan_type, width_px, wavelength_start_nm, wavelength_end_nm, num_patterns, exposure_time):
        return _NIRScanner.NIRScanner_setSlewConfigSection(self, section_index, section_scan_type, width_px, wavelength_start_nm, wavelength_end_nm, num_patterns, exposure_time)

    def applySlewConfig(self):
        return _NIRScanner.NIRScanner_applySlewConfig(self)
