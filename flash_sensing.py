...
from DLPComposer.Commands.DLPC347x import Command, FlashDataTypeSelect
...
def flash_sensing():
    ...
    print(f"--- STARTING DLPC347x SENSING FLASH (v1.1.8) ---")
    ...
    try:
        ...
        print("Initializing EntireFlash Update (Sensing Library)...")
        WriteFlashDataTypeSelect(FlashDataTypeSelect.EntireFlash)
        
        print("Erasing (60 seconds)...")
        WriteFlashErase()
        time.sleep(60)
